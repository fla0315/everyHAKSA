				...
				<tr class="align_center">
					...
					<td class="align_left">
						...
						<c:if test="${vo.delFlag=='Y'}">
							 <span style="color: gray;">원본글이 삭제 되었습니다.</span>
						</c:if>	
						
						<c:if test="${vo.delFlag=='N'}">
							<!-- 파일이 첨부된 경우에만 파일 이미지 보여주기 -->					
							<c:if test="${!empty vo.fileName}">
								<img alt="이미지" src="<c:url value='/resources/images/file.gif'/>">
							</c:if>
				        	...
				        	<c:if test="${vo.step > 0}">
					        	...
					        	<img alt="리플" src="<c:url value='/resources/images/re.gif'/>">
					        </c:if>
							...
							<c:if test="${vo.newImgTerm <24 }">
								<img alt="" src="<c:url value='/resources/images/new.gif'/>">
							</c:if>
