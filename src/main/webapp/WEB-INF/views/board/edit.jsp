...
<form name="frmEdit" method="post" action="<c:url value='/board/edit.do'/>"> 
	...
	<legend>글수정</legend>
        <div class="firstDiv">
            ...
            <input type="text" id="title" name="title" class="infobox" value="${vo.title}" />
        </div>
        <div>
            <label for="name">작성자</label>
            <input type="text" id="name" name="name" class="infobox" value="${vo.name}" />
        </div>
        <div>
            <label for="pwd">비밀번호</label>
            <input type="password" id="pwd" class="infobox" name="pwd" />
        </div>
        <div>
