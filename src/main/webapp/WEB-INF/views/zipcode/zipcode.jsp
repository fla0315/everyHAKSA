...
<body>
   ...
   <form name="frmZipcode" method="post" action="<c:url value='/zipcode/zipcode'/>">
      ...
      <input type="text" name="dong" id="dong" style="ime-mode:active" value="${param.dong }">
      <input type="submit" id="submit" value="찾기">
   </form>
   <br>
   
      <table style="width:470px" class="box2" summary="우편번호 검색 결과에 관한 표로써, 우편번호, 주소에 대한 정보를 제공합니다.">  
         <colgroup>
            <col style="width:20%" />
            <col style="width:*" />            
         </colgroup>
         ...
         <tbody>
            <c:if test="${empty list }"> <!-- DB작업 했으나 데이터가 없을때 -->
               <tr>
